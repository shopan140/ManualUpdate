...
public class VolatilityIndexDataUpdateTask {
public static final SimpleDateFormat dateformat = new SimpleDateFormat("yyyy-MM-dd");
	
	
	public static void VolatilityDataUpdateProcess(Connection conL) throws ClassNotFoundException, SQLException, ParseException{
		...
		while (rsL.next()) {
			...
			dd_date.add(d_date);
			SpikeCalculation_UpdateVolatilityRows(d_date,conL);
		}
	...
	public static void SpikeCalculation_UpdateVolatilityRows(String desired_date,Connection con) throws ClassNotFoundException, SQLException, ParseException{
